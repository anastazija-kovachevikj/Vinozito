        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Animations = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Music = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Flashes = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Sounds = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    StrongColors = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomCard_DefaultCardId",
                table: "CustomCard",
                column: "DefaultCardId");
